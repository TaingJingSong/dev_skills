...
|--------------------------|-----------|--------------------|-------------------------------------------|
| Teal – table header bg   | `#1A949D` | `1A949D`           | All table header rows                     |
| White – header text      | `#FFFFFF` | `FFFFFF`           | Text inside teal header cells             |
| Light blue – label cells | `#D9EAF7` | `D9EAF7`           | Left-column label cells in key-value tables |
| Alt light blue           | `#EAF2F8` | `EAF2F8`           | Secondary label cells or alternating rows |
| Black – body text        | `#000000` | `000000`           | Body text                                 |
| Cover page accent        | `#1A949D` | `1A949D`           | Cover page horizontal rule / accents      |

> **Source-verified:** These exact hex values were extracted from the InnoTech standardized
> template files (`.docx`). Always use these values — do not substitute similar blues or teals.
